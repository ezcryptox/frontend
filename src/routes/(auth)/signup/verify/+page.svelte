...
<div class="wc-signup">
  <div class="_848abb12 bf2bd91d">
    ...
    <div data-v-39752d79="" class="order-form">
        ...
        <div class="form-item-content">
          ...
          <div class="_041e59c9">
            <span>
              ...
              <button
                disabled={canResend}
                on:click={() => handleResent()}
                class="a30257f6 _1f498e28"
              >
                Resend{canResend ? `(${canResend})` : ""}
              </button>
            </span>
          </div>
      ...
      <button
        disabled={trackActivator}
        on:click={handleSubmit}
        type="button"
        class="polo-btn polo-btn-button polo-btn-primary polo-btn-medium _0ccbd664"
        data-v-39752d79=""
      >
        <!---->
