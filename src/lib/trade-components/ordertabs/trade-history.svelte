...
<div class="_67f779d2 _6d122bdf">
	...
	>
		...
		<div class="el-table__header-wrapper">
			...
			>
				<colgroup
					><col name="el-table_11_column_99" /><col
						name="el-table_11_column_100"
					/><col name="el-table_11_column_101" /><col
						name="el-table_11_column_102"
					/><col name="el-table_11_column_103" /><col
						name="el-table_11_column_104"
					/><col name="el-table_11_column_105"><col
						name="gutter"
						width="0"
					/></colgroup
				><thead class="has-gutter"
					><tr class="" 
						><th
							colspan="1"
							rowspan="1"
							class="el-table_11_column_99 _7253fece is-leaf el-table__cell"
							><div class="cell">Time</div></th
						><th colspan="1" rowspan="1" class="el-table_11_column_100 is-leaf el-table__cell"
							><div class="cell">Pair</div></th
						><th colspan="1" rowspan="1" class="el-table_11_column_101 is-leaf el-table__cell"
							><div class="cell">Side</div></th
						><th colspan="1" rowspan="1" class="el-table_11_column_102 is-leaf el-table__cell"
							><div class="cell">Price</div></th
						><th colspan="1" rowspan="1" class="el-table_11_column_103 is-leaf el-table__cell"
							><div class="cell">Amount</div></th
						><th colspan="1" rowspan="1" class="el-table_11_column_104 is-leaf el-table__cell"
							><div class="cell">Total</div></th
						><th
							colspan="1"
							rowspan="1"
							class="el-table_11_column_105 is-right is-leaf el-table__cell"
							><div class="cell">Fees</div></th
						><th class="el-table__cell gutter" style="width: 0px; display: none;"></th></tr
					></thead
				>
			</table>
		</div>
		<div class="el-table__body-wrapper is-scrolling-none" style="height: 219px;">
			<table
				cellspacing="0"
				cellpadding="0"
				border="0"
			...
			>
				<colgroup
					...
					/><col name="el-table_11_column_103" /><col
						name="el-table_11_column_104"
					/><col name="el-table_11_column_105" /></colgroup
				><tbody><!----></tbody>
			</table>
