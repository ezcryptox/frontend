...
<div class="_5827c8b6 _6d122bdf" activeindex="3">
	<div
		class="el-table order-table el-table--fit el-table--enable-row-hover el-table--small d9f59dac"
		style="height: 100%;"
	>
		<div class="hidden-columns">
			<div></div>
			<div
				tips="The amount of the chosen currency that can be traded without borrowing, excluding the assets in use"
			></div>
			<div tips="Assets on open orders or in withdrawals"></div>
			<div
				tips="A currency's balance equals the sum of its available amount and assets in use minus the amount of assets borrowed"
			></div>
			<div></div>
		</div>
		<div class="el-table__header-wrapper" >
			...
			>
				<colgroup
					><col name="el-table_12_column_106" /><col
						name="el-table_12_column_107"
					/><col name="el-table_12_column_108"/><col
						name="el-table_12_column_109"
					/><col name="el-table_12_column_110"/><col
						name="gutter"
						width="0"
					/></colgroup
				><thead class="has-gutter"
					><tr class="" 
						><th colspan="1" rowspan="1" class="el-table_12_column_106 is-leaf el-table__cell"
							><div class="cell">Coin</div></th
						><th colspan="1" rowspan="1" class="el-table_12_column_107 is-leaf el-table__cell"
							><div class="cell">
								<span
									class="el-tooltip tips-text _820dbab2"
									aria-describedby="el-tooltip-4044"
									tabindex="0">Available</span
								>
							</div></th
						><th colspan="1" rowspan="1" class="el-table_12_column_108 is-leaf el-table__cell"
							><div class="cell">
								<span
									class="el-tooltip tips-text _820dbab2"
									aria-describedby="el-tooltip-260"
									tabindex="0">In Use</span
								>
							</div></th
						><th
							colspan="1"
							rowspan="1"
							class="el-table_12_column_109 is-right is-leaf el-table__cell"
							><div class="cell">
								<span
									class="el-tooltip tips-text _820dbab2"
									aria-describedby="el-tooltip-5856"
									tabindex="0">Balance</span
								>
							</div></th
						><th
							colspan="1"
							rowspan="1"
							class="el-table_12_column_110 is-right is-leaf el-table__cell"
		...
		<div class="el-table__body-wrapper is-scrolling-none" style="height: 252px;">
			<table
				cellspacing="0"
				cellpadding="0"
				border="0"
			...
			>
				<colgroup
					...
					/><col name="el-table_12_column_108"/><col
						name="el-table_12_column_109"
					/><col name="el-table_12_column_110" /></colgroup
				><tbody><!----></tbody>
			</table>
				...
				<span class="el-table__empty-text"
					...
					<div class="e0263add">
						...
						<div class="_4309a313">
							...
							{:else}
							<div class="_9e7987dd"><a href="/login">Log In </a>or <a href="/signup">Sign Up </a> Now to trade </div>
						{/if}
