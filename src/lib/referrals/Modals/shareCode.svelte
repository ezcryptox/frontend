...
<div>
  <div class="fef54d3a">
    <div class="flex justify-between _893633d3">{$_('share-your-referral-code')}<span class="_438ff511"
        ><svg
          ...
          ><path
            ...
            fill="#B8B8B8"
          ></path></svg
        ><a href="javascript:;">{$_('referral-center')}</a></span
      >
    </div>
    <div class="_288b3943">
      <!---->
    ...
    <div class="_5370c68a">
      ...
      <div class="bb8d5c1d">
        <svg
          ...
          viewBox="0 0 16 16"
          fill="none"
          ><path d="M6 1.75H14.25V10H12.75V3.25H6V1.75Z" fill="currentColor"
          ></path><path
            fill-rule="evenodd"
            clip-rule="evenodd"
    ...
    <div class="flex justify-between e8611f99">
      <button class="_1a0f7f35" on:click={handleRefModal}>{$_('invite-friends-now')}</button>
