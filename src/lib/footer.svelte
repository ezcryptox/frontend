    ...
    <footer class="beb6dc28 uniframe-root">
        <div class="e2fff687">
            <section class="ce1f9e13">
                <aside class="fa9ae9d7">
                    <div class="eb13f307">
                        <h2>Start trading</h2>
                        <div class="bb407533">
                            <a href="/signup" class="abc20fb3" aria-label="signup">Sign Up</a>
                            <a href="/login" class="abc20fb3" aria-label="login">Log In</a>
                        </div>
                        <div class="ca0fb6d9">
                ...
                <main class="e5cc3d28">
                    <div class="">
                        <div class="a1d7703b">Language</div>
                        <div class="fa317b72">English
            ...
            <section class="c17a4fd0">
                <div class="f234f27f">
                  <img src="https://res.cloudinary.com/dxwhz3r81/image/upload/v1715952262/ezcryptox.ioo-04_y1qyp7.png" alt="">
