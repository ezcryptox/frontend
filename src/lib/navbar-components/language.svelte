...
{#if showLanguageModal}
	...
	<div id="uniframe-dialog" data-v-app="" on:click>
		<div
		...
		>
			...
			<div class="vfm__content vfm--outline-none uniframe-root" tabindex={selectedTab}>
				<div class="cfb48486">
					<div class="a57f6789">
						<!-- svelte-ignore a11y-no-noninteractive-element-interactions -->
						<ul>
							<!-- svelte-ignore a11y-click-events-have-key-events -->
							<!-- svelte-ignore a11y-no-noninteractive-element-interactions -->
							<li class={selectedTab === 0 ? 'a51c0809' : ''} on:click={() => onTabChanged(0)}>
								{$_('global-language')}
							</li>
					...
					<div class="b6cfa543">
						<ul>
							{#each tabList as value, index}
								...
								<!-- svelte-ignore a11y-no-noninteractive-element-interactions -->
								<li
									class={selectedTabItem === index ? 'a51c0809' : ''}
									on:click={(ev) => {
